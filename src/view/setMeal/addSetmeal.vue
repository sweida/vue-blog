...
<div>
    ...
    <div class="form_box form_top">
      ...
      <el-form ref="form" :model="form" label-width="120px" label-position='left'>
        ...
        <el-form-item label="所属类目">
          <el-cascader placeholder="请选择类目名称" @change="handleItemChange" v-model="selectedOptions" change-on-select :options="menuList" :props="defaultProps" :clearable="true">
          </el-cascader>
        </el-form-item>
      ...
      <div class="uploader_box">
        <el-upload class="uploader" action="/apis/file/pic/package" :show-file-list="false" :on-success="handleAvatarSuccess" :on-error="fileUploadError" :before-upload="beforeAvatarUpload">
      ...
      <div class="contents">
        ...
        <div v-for="(item, index) in ccPackageGroupVoList">
          ...
          <div class="meal_box" v-if="item.groupType == 2">
            ...
            <div class="set_table">
              <el-table :data="item.ccPackageGroupDetailList" stripe style="width: 100%" max-height="600" tooltip-effect="dark">
                <el-table-column prop="projectName" label="名称">
                </el-table-column>
                <el-table-column width="100px" label="产品价格">
          ...
          <div class="meal_box" v-if="item.groupType == 1">
            ...
            <div class="set_table">
              <el-table :data="item.ccPackageGroupDetailList" stripe style="width: 100%" max-height="600" tooltip-effect="dark">
                ...
                <el-table-column width="100px" label="消耗价格">
                  <template slot-scope="scope">
                        <el-input size="mini" class="count" v-model="scope.row.projectPrice"></el-input>
                      </template>
                </el-table-column>
                <el-table-column prop="bed" label="是否必选">
                  <template slot-scope="scope">
                        <el-switch
          ...
          <div class="meal_box" v-if="item.groupType == 4">
            ...
            <div class="set_table">
              <el-table :data="item.ccPackageGroupDetailList" stripe style="width: 100%" max-height="600" tooltip-effect="dark">
                ...
                <el-table-column width="140px" prop="projectPrice" label="代金券金额（元）">
                </el-table-column>
                <el-table-column label="删除">
                  <template slot-scope="scope">
                        <i class="el-icon-delete" @click="deleteBtn(scope.$index,item.ccPackageGroupDetailList)"></i>
  ...
  <el-dialog :visible.sync="addProductDialog" title="选择产品" width="1050px" class="burbox">
    <div class="tableDialog">
      ...
      <div class="burli1">
        <el-table :data="materials_arr" stripe style="width:100%" max-height='450' @selection-change="handleSelectionChange" tooltip-effect="dark">
          <el-table-column label="选择" type="selection" width="80">
          </el-table-column>
          <el-table-column label="序号" type="index" width="50">
          </el-table-column>
          <el-table-column prop="projectName" label="名称">
          </el-table-column>
          <el-table-column prop="projectPrice" label="价值">
          </el-table-column>
        </el-table>
      ...
      <!-- 选择产品 -->
      <div class="burli2">
        <el-table :data="multipleSelection" stripe style="width:100%" max-height='450' tooltip-effect="dark">
          <el-table-column prop="projectName" label="名称">
          </el-table-column>
          <el-table-column prop="projectPrice" label="价值">
          </el-table-column>
  ...
  methods: {
    ...
    selectDown(command) {
      if (command == 'a') {
        ...
        this.ccPackageGroupVoList.push({ //添加产品数据
          groupName: '',
          groupType: 2,
          groupTime: '1', // 次数
          ccPackageGroupDetailList: []
