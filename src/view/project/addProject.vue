...
<div>
  ...
  <div class="main-content scroll">
        ...
        <transition name="el-zoom-in-top">
          <div v-show="moredes" class="transition-box">
            ...
            <div class="form_box">
              <h6>适合肤质</h6>
              <div class="li_box">
                <el-checkbox-group v-model="checkSkin" v-if="editSkin">
            ...
            <div class="form_box">
              <h6>功效</h6>
              <div class="li_box">
                <el-checkbox-group v-model="checkEffect" v-if="editEffect">
    ...
    <div class="form_box">
      <h5>优惠赠送</h5>
      <div class="li_box">
        <el-tag v-for="(item, index) in ccProjectGiveList" :key="item.id" closable :disable-transitions="false" @close="CloseGiveTags(index)">
  ...
  <el-dialog :visible.sync="burdenDialog" title="编辑配料" width="1200px" class="burbox">
    <div class="tableDialog">
      ...
      <div class="burli1">
        <el-table :data="materials_arr" stripe style="width:100%" max-height='450' tooltip-effect="dark" @selection-change="addMaterials">
          <el-table-column prop="materialName" label="配料名称">
          </el-table-column>
      ...
      <!-- 默认配料 -->
      <div class="burli2">
        <el-table :data="form.ccProjectMaterialList" stripe max-height='200' tooltip-effect="dark">
          <el-table-column prop="materialName" label="已添加配料">
          </el-table-column>
          <el-table-column prop="unit" label="单位">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    addGiveList() {
      ...
      this.$refs.addGiveChild.materials_data = clone(this.ccProjectGiveList)
