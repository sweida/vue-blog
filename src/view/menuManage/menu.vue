<template>
  <div>
    ...
    <el-row :gutter="20" type="flex" class="scroll">
      <el-col :span="20">
        <div class="main-content scroll">
          ...
          <el-table :data="menuList" style="width: 100%" v-loading="loading" element-loading-text="拼命加载中"
                    size="mini"
          ...
          <page :pageModel="pageModel" @selectList="selectMenuList" v-if="pageModel.sumCount>10"></page>
        </div>
      </el-col>
      <el-col :span="4">
        <el-menu
    ...
    <el-dialog
      :title="title"
      :visible.sync="menuEdDialog"
      width="30%"
      @close="menuEdDialogClose"
      center>
      <el-form ref="menu" :rules="rules" :model="menu" label-width="80px">
        ...
        <el-form-item label="功能权限">
          ...
          <el-dialog
            width="15%"
            title="添加权限"
            :visible.sync="authButDialog"
            append-to-body center top="15%">
            <el-input
              v-model="authBut.authIden"
